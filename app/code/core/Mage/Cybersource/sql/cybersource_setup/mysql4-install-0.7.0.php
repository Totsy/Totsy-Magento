...
$installer->addAttribute('quote_payment', 'cybersource_subid', array());

$installer->addAttribute('order_payment', 'cybersource_token', array());
$installer->addAttribute('order_payment', 'cybersource_subid', array());

$installer->addAttribute('invoice', 'cybersource_token', array());
$installer->addAttribute('invoice', 'cybersource_subid', array());


$installer->addAttribute('creditmemo', 'cybersource_token', array());
$installer->addAttribute('creditmemo', 'cybersource_sudid', array());
