...
CREATE TABLE `{$this->getTable('CustomerIndex/CustomerIndex')}` (
  ...
  `customer_name` varchar(255) DEFAULT NULL COMMENT 'Concat Full Name',
  ...
  KEY `IDX_CUSTOMER_ENTITY_FLAT_FIRSTNAME` (`firstname`),
  KEY `IDX_CUSTOMER_ENTITY_FLAT_LASTNAME` (`lastname`),
  KEY `IDX_CUSTOMER_ENTITY_FLAT_FIRSTNAME_LASTNAME` (`firstname`,`lastname`),
