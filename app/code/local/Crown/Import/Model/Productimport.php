...
class Crown_Import_Model_Productimport extends Crown_Import_Model_Import_Abstract {
    ...
    protected function loadFilters() {
        ...
        $this->addRowFilter ( array (&$this, 'filterPricing'), 2 );
    ...
    /**
     * Removes whitespace at beginning and end of a value
     * @param string $value
     * @since 1.3.1
     * @return string
     */
    ...
    /**
     * Convert non-numeric prices
     * @param string $value
     * @since 1.3.1
     * @return string
     */
    public function filterConvertPriceToNumeric($value) {
    ...
    /**
     * Sets the default attribute set if it's not set
     * @param mixed int|string $_id
     * @param array $data
     * @since 1.0.0
     * @return array
    ...
    /**
     * Filter to make sure product pricing is numeric
     * @param mixed int|string $_id
     * @param array $data
     * @since 1.3.1
     * @return array
     */
    public function filterPricing($_id, $data) {
        if ( isset($data['price']) ) {
            $data['price'] = $this->filterConvertPriceToNumeric($data['price']);
        }
        if ( isset($data['special_price']) ) {
            $data['special_price'] = $this->filterConvertPriceToNumeric($data['special_price']);
        }
        if ( isset($data['sale_wholesale']) ) {
            $data['sale_wholesale'] = $this->filterConvertPriceToNumeric($data['sale_wholesale']);
        }
        return $data;
    }
