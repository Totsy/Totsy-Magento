...
class Varien_Data_Form_Element_Image extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            //Harapartners, Jun: do NOT restrict image size
            $html = '<a href="'.$url.'" onclick="imagePreview(\''.$this->getHtmlId().'_image\'); return false;"><img src="'.$url.'" id="'.$this->getHtmlId().'_image" title="'.$this->getValue().'" alt="'.$this->getValue().'" class="small-image-preview v-middle" /></a> ';
        ...
        //Harapartners, Jun: input field begins a new line
