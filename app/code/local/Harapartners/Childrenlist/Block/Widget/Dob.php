...
class Harapartners_Childrenlist_Block_Widget_Dob extends Harapartners_Childrenlist_Block_Widget_Abstract
{
    /**
     * Date inputs
     *
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('childrenlist/widget/dob.phtml');
    }
    ...
    {
        return $this->getChildInfo()->getChildBirthday();
    }
    
    public function getDay()
    {
        return $this->getTime() ? date('d', strtotime($this->getTime())) : '';
    }

    public function getMonth()
    {
        return $this->getTime() ? date('m', strtotime($this->getTime())) : '';
    }

    public function getYear()
    {
        return $this->getTime() ? date('Y', strtotime($this->getTime())) : '';
    }
