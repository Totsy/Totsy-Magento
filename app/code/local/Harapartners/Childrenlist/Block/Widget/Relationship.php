 ...
 */
class Harapartners_Childrenlist_Block_Widget_Relationship extends Harapartners_Childrenlist_Block_Widget_Abstract
{
    /**
     * Initialize block
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('childrenlist/widget/relationship.phtml');
    }
