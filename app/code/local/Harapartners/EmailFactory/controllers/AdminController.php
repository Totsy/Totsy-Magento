<?php
    class Harapartners_EmailFactory_AdminController extends Mage_Adminhtml_Controller_Action {
        public function indexAction() {
            $this->loadLayout()->_addContent($this->getLayout()->createBlock("emailfactory/form"))->renderLayout();
        }
