 ...
 */
class Webshopapps_Shipdiscount_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form
	...
	protected function _prepareForm()
    {
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'options'    => array(
                ...
                Webshopapps_Shipdiscount_SalesRule_Model_Rule::BY_SHIP_PERCENT_ACTION => Mage::helper('salesrule')->__('Percent of shipping price discount'),
                Webshopapps_Shipdiscount_SalesRule_Model_Rule::BY_SHIP_FIXED_ACTION => Mage::helper('salesrule')->__('Fixed shipping price discount'),
