...
class Mage_Reports_Model_Resource_Report_Collection
{
    ...
    //Hara Song
    public function getReportFullWithCustomerEmail($from, $to, $email)
    {
    	return $this->_model->getReportFullWithEmail($this->timeShift($from), $this->timeShift($to), $email);
    }
    /**
     * Get report
     *
    ...
    {
    	return $this->_model->getReportWithCustomerEmail($this->timeShift($from), $this->timeShift($to), $email);
    }
