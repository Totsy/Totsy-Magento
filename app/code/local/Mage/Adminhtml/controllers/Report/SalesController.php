...
class Mage_Adminhtml_Report_SalesController extends Mage_Adminhtml_Controller_Action
{
	...
	public function refreshSevendaysAction(){
        return $this->_forward('refreshSevendays', 'report_statistics');
    }
    
	public function refreshLastmonthAction(){
        return $this->_forward('refreshLastmonth', 'report_statistics');
    }
    
	public function refreshfromdateAction(){
        return $this->_forward('refreshfromdate', 'report_statistics');
    }
