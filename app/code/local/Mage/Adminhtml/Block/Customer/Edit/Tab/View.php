 ...
 implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function getAffiliate() {
        $affiliate = Mage::getModel('customertracking/record')->load($this->getCustomer()->getId(), 'customer_id');
        if($affiliate) {
            return $affiliate->getAffiliateCode();
        }
    ...
    public function getInvitationCount() {
        ...
        if($invitations->getData()) {
            return count($invitations->getData());
        }
