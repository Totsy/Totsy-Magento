...
class Enterprise_WebsiteRestriction_Model_Observer
{
    ...
    public function restrictWebsite($observer)
    {
        ...
        if (!Mage::app()->getStore()->isAdmin()) {
            ...
            if( preg_match( "/\/(invitation|invite|faq|privacy|rss|affiliates|careers|aboutus|meet-the-moms|press|video-testimonials|being-green|totsy-blog|contact|inchoo_facebook|resetpassword|resetpasswordpost|facebook|inchoo|mobileapi|affiliate|terms|return-policy|privacy-policy|terms-of-use|a)\//i", Mage::app()->getRequest()->getRequestUri() ) ){
            	return;
            }
