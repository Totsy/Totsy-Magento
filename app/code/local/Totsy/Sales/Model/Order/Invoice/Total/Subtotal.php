...
class Totsy_Sales_Model_Order_Invoice_Total_Subtotal extends Mage_Sales_Model_Order_Invoice_Total_Subtotal
{
    /**
    ...
    public function collect(Mage_Sales_Model_Order_Invoice $invoice)
    {
        ...
        if ($invoice->isLast() && !$order->containsCanceledItems()) {
