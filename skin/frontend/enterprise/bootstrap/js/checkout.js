...
jQuery(document).ready(function() {
    ...
    checkoutPayment = (function(profileEnabled) {
        var hasProfile = profileEnabled;
        var isCollapsed = "";
    ...
    jQuery("#paymentfactory_tokenize_cc_number").keyup(function() {
        ...
        if (isCard == true) {
            ...
            if (jQuery('[id="payment[cybersource_subid]"]').val() !== "") {
                jQuery('[id="payment[cybersource_subid]"]').val(checkoutPayment.lastUsedAddressId);
